...
# ML/AI Service API URL (port 5001)
...
- **Backend API** (port 5000): Image/Video generation, file uploads, health checks
- **ML Service API** (port 5001): AI/ML model inference (Stable Diffusion, audio generation)
